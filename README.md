...
Preprint on *bioRxiv*, DOI: [10.1101/2022.08.02.502481](https://www.biorxiv.org/content/10.1101/2022.08.02.502481)

Published in *Communications Biology*, DOI: [10.1038/s42003-024-06259-6](https://www.nature.com/articles/s42003-024-06259-6)
...
mds.calc <- function(ps, y){
  ...
  dist.mat <- phyloseq::distance(ps, method = "unifrac")
  cap_ord <- ordinate(physeq = ps, method = "NMDS", distance = dist.mat, formula = ~ 1)$points %>% as.data.frame %>% tibble::rownames_to_column("sample")
